...
@Component({
  selector: 'app-full-booking-entry',
  imports: [CommonModule,
    ...
    FormsModule,
    PanelModule,],
  templateUrl: './full-booking-entry.component.html',
  styleUrl: './full-booking-entry.component.css'
})
export class FullBookingEntryComponent {
  ...
  onBranchSelect(branch: any) {
    if (this.fullBookingFrom) {
      this.fullBookingFrom.get('branch_id').setValue(branch.value.Id);
      // console.log(branch);
    }
  }
  ...
  onCitySelect(city: any) {
    if (this.fullBookingFrom) {
      this.fullBookingFrom.get('FromCityID').setValue(city.value.Id);
    }
    // console.log(city);
  }
  ...
  onToCitySelect(city: any) {
    if (this.fullBookingFrom) {
      this.fullBookingFrom.get('ToCityID').setValue(city.value.Id);
    }
    // console.log(city);
  }
