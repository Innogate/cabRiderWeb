...
async generatePdf(invoice: any, charges: any) {
  ...
  const invoiceData = {
    ...
    items: [
      ...
      { particulars: 'Holiday days                0 X 0', amount: String(invoice.holiday ?? 'N/A') },
      ...
      { particulars: 'Add : Night Halt Amount        0 X 0 ', amount: String(invoice.nightHalt ?? '0.00') },
      { particulars: 'Add : Night Halting Charges        0 X 0 ', amount: String(invoice.night_amount ?? '0.00') },
